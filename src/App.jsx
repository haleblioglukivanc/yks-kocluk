...
export default function App() {
  ...
  function icerik() {
    ...
    if (kocMu && yol === '/yapilacaklar') return <YapilacaklarEkrani onOgrenciAc={(id) => git(`/ogrenci/${id}`)} onMesaj={(id) => git(`/mesajlar/${id}`)} onGozuyle={(id) => git(`/gozuyle/${id}`)} tepe={{ ...anaTepe, onZil: undefined, onGeri: () => git('/') }} />
    if (kocMu && (yol === '/ogrencilerim' || yol === '/ogrenciler')) return <OgrencilerimEkrani onOgrenciAc={(id) => git(`/ogrenci/${id}`)} onMesaj={(id) => git(`/mesajlar/${id}`)} onGozuyle={(id) => git(`/gozuyle/${id}`)} tepe={{ ...anaTepe, onGeri: () => git('/') }} />
    if (kocMu)
