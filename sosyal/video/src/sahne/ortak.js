...
export const ZEMIN = {
  krem:    { bg: P.krem,     yazi: P.murekkep, soluk: '#4a5570', etiket: '#8a5a00', dolgu: P.nane,    koyu: false, vurguCizgi: P.amber },
  kum:     { bg: P.kum,      yazi: P.murekkep, soluk: '#4a5570', etiket: '#8a5a00', dolgu: P.seftali, koyu: false, vurguCizgi: P.amber },
  murekkep:{ bg: P.murekkep, yazi: P.krem,     soluk: '#cfd6e6', etiket: P.amber,   dolgu: P.gok,     koyu: true, vurguCizgi: P.amber },
  nane:    { bg: P.nane,     yazi: P.murekkep, soluk: '#1f4a3c', etiket: '#1f4a3c', dolgu: P.krem,    koyu: false, vurguCizgi: P.murekkep },
  seftali: { bg: P.seftali,  yazi: P.murekkep, soluk: '#5a2e1c', etiket: '#5a2e1c', dolgu: P.krem,    koyu: false, vurguCizgi: P.murekkep },
  gok:     { bg: P.gok,      yazi: P.murekkep, soluk: '#1e3470', etiket: '#1e3470', dolgu: P.krem,    koyu: false, vurguCizgi: P.amber },
}
...
// Metinden sabit sayı üreteci: aynı gün hep aynı seçim, farklı günler farklı
export function tohumla(metin) {
  let h = 2166136261
  for (const c of String(metin)) h = Math.imul(h ^ c.codePointAt(0), 16777619)
